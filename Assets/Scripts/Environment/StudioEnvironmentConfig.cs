...
{
    /// <summary>
    /// Configuracion centralizada del ambiente visual.
    /// Cambia los valores AQUI y todas las escenas se actualizan automaticamente.
    /// Crear: Assets > Create > ASL LearnVR > Studio Environment Config
    /// </summary>
    ...
    {
        [Header("=== FLOOR (Suelo con degradado radial) ===")]
        ...
        [Tooltip("Radio del degradado")]
        public float floorGradientRadius = 3.0f;

        [Tooltip("Suavidad del degradado")]
        [Range(0f, 1f)]
        ...
        [Header("=== WALLS (Paredes curvas con degradado vertical) ===")]
        ...
        [Tooltip("Altura del degradado")]
        public float wallGradientHeight = 4.0f;

        [Tooltip("Nivel del suelo (Y)")]
        ...
        [Tooltip("Radio de la esfera invertida")]
        public float wallRadius = 10f;

        [Tooltip("Altura del centro de la esfera")]
